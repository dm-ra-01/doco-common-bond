---
title: "Dr Ryan Ammendolea — Founder"
sidebar_label: The Founder
sidebar_position: 2
description: The personal story of Dr Ryan Ammendolea — ICU Registrar, software engineer, and founder of Common Bond. How two careers became one mission.
...
```mermaid
timeline
    title Ryan's Journey to Common Bond
    2005 : Engineering career begins
         : Senior Network Engineer roles across WA
    2007 : BSc Internetworking & Security
         : Murdoch University — Top 2%, VC Commendation
    2008 : St John Ambulance
         : Volunteer EMT, responding to 000 calls
         : Outer metropolitan & regional WA
    2016 : Doctor of Medicine
         : University of Notre Dame Australia (Fremantle)
         : Dean's Commendation all 4 years
    2020 : Medical Internship
         : Fiona Stanley & Fremantle Hospitals, WA
         : National Service Medal — St John Ambulance
    2021 : Monash Health
         : Critical Care HMO — ICU, Anaesthetics
    2023 : Receptor v1
         : ICU Registrar, Monash Health
         : Monash ICU Survival Guide launched
         : Receptor built in parallel with clinical shifts
    2024 : Common Bond incorporated
         : Receptor publicly launched
         : ISO 27001 compliance program initiated
    2026 : First major metropolitan pilot
         : Active engagement with Monash Health
```
