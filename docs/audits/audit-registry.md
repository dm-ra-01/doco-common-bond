...
| :--------------------------------------- | :----------------------------------------- | :--------------------------------------------------------------------- | :---------- | :---------- | :----------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `260306-frontend-standards`              | Frontend Engineering Standards Audit       | `docs/engineering/frontend-standards-overview.md` + all frontend repos | Antigravity | ✅ Complete | —                                                                              | [audit.md](../audits/260306-frontend-standards/audit.md) · [recommendations.md](../audits/260306-frontend-standards/recommendations.md)                                           |
