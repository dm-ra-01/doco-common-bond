...
| :------------------------------ | :------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------- | :---------- | :-------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `260311-testing-efficiency`     | Testing Efficiency & Modularity Audit | `backend/receptor-planner`, `backend/match-backend`, `frontend/planner-frontend`, `frontend/workforce-frontend`, `frontend/preference-frontend`, `supabase-receptor` | Ryan Ammendolea | 🔄 Drafting | —         | [audit.md](../audits/260311-testing-efficiency/audit.md) · [recommendations.md](../audits/260311-testing-efficiency/recommendations.md)                         |
