...
**Capabilities:**
- Automated matching via [Allocation Algorithm](/docs/app-documentation/allocator-backend/algorithm)
...
| Attribute | Value |
|-----------|-------|
| **Status** | Market Research Complete ([Analysis](/docs/business-planning/research/vocational-training-analysis)) |
...
- [Product Roadmap](./product-roadmap) — Timeline-based view of capability development
- [V/TO (Scope & Boundaries)](../operations/eos/vto#scope--boundaries) — Functional boundaries and exclusions
- [Vocational Training Analysis](../research/vocational-training-analysis) — Market research for extension services
