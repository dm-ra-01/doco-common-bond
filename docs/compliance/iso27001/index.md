...
This section serves as the Information Security Management System (ISMS) for
**Common Bond (Receptor Platform)**. It identifies our policies, procedures, and
controls to secure our information assets.

> **Status:** Pre-Certification / Implementation Phase.

## ISMS Structure

Our ISMS is structured to be lightweight and practical for a pre-revenue
startup.

### 1. [Governance](/docs/compliance/iso27001/governance/)
