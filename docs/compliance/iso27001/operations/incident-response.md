...
| **Secret leakage**    | Gitleaks or manual discovery of secrets (API keys, DB creds) in code |        P1-P2     | Immediate containment (Phase 2). Revoke and rotate the compromised secret. Document scope of exposure. |
