...
| 7.10       | Storage media                                         | Yes        | Portable storage media (USB drives) poses data exfiltration risk                                                                      | Partial — USB storage is not permitted per policy (confirmed by Founder 2026-03-05); formal written prohibition not yet documented in the Acceptable Use Policy |
