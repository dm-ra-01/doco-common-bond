...
| Document | Purpose |
|----------|---------|
| **[ASIC Registration](./asic-registration)** | Official corporate registration as Common Bond Pty Ltd. |
| **[First 30 Days Roadmap](../projects/common-bond-setup)** | Operational and legal setup milestones. |
...
| Document | Purpose |
|----------|---------|
| **[Risk Management](./risk-management)** | Data privacy, clinical risks, and regulatory alignment. |
| **[Ethics & AI Governance](./ethics-ai-governance)** | Fairness, transparency, and human-in-the-loop matching. |
| **[Governance & Exit](./governance-exit)** | Long-term strategy and succession planning. |
