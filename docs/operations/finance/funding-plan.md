---
title: Funding & Capital Efficiency Plan
sidebar_label: Funding Plan
sidebar_position: 2
---
...
```mermaid
xychart-beta
    title "FY2027 Quarterly Expenditure Projection"
    x-axis [Q1, Q2, Q3, Q4]
    y-axis "Spending ($AUD)" 0 --> 50000
    bar [42000, 38000, 36000, 34000]
```
...
```mermaid
pie title Capital Allocation by Function
...
Based on the [Revenue Model](./revenue-model.md) and [Pricing Projections](./pricing-projections.md), break-even is projected as follows:
...
📊 See [Pricing Projections](./pricing-projections.md) for comprehensive phase-by-phase analysis.
