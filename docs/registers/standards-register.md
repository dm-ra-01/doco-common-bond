...
| `ENG-STD-009` | Python Design Patterns Standard  | Standard | `backend/planner-backend`, `backend/match-backend`             | Engineering Leadership | 2026-03-05     | 2027-03-01  | ✅ Active | `backend/planner-backend/.agents/skills/python-design-patterns/`  |
| `ENG-STD-010` | Python Testing Patterns Standard | Standard | `backend/planner-backend`, `backend/match-backend`             | Engineering Leadership | 2026-03-05     | 2027-03-01  | ✅ Active | `backend/planner-backend/.agents/skills/python-testing-patterns/` |
